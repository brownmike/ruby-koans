...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # Same reason it provides fail & raise?
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # You can redefine it to interpret the method name is an
    # input to a program and do something useful with it like
    # ActiveRecord famously does.
    #
    # NOTE:
    #
